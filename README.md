# 伊娃桌面宠物 · Mac 2.0.3 / Windows 13.3.2
...
<p align="center">
  ...
  <a href="https://github.com/wangkaikaise/Eva-Desktop-Pet/releases/tag/windows-v13.3.2"><img src="https://img.shields.io/badge/Windows-13.3.2-0078D4?style=flat-square&logo=windows11" alt="Windows 13.3.2"></a>
...
> [下载 Mac 2.0.3](https://github.com/wangkaikaise/Eva-Desktop-Pet/releases/tag/v2.0.3) · [下载 Windows 13.3.2](https://github.com/wangkaikaise/Eva-Desktop-Pet/releases/tag/windows-v13.3.2)
...
- CPU 温度默认采用核心平均口径，与 Core Temp 等核心监控工具更接近；最高热点仍可在设置中选择
- 眼睛动作切换改为单路径连续变形，移除淡出端点黑点和重叠横线
...
- 下载 `Eva-Desktop-Pet-Windows-13.3.2-x64.zip`，解压后运行 `EvaDesktopPet.exe`

...
class SettingsDialog(QDialog):
    ...
    def _build_metrics_page(self):
        ...
        self.combo_cpu_temp_mode.addItem("核心平均温度（推荐）", "avg")
        self.combo_cpu_temp_mode.addItem("最高热点温度", "max")
    ...
    def _load_values(self):
        ...
        self.combo_cpu_temp_mode.setCurrentIndex(
            self.combo_cpu_temp_mode.findData(getattr(s, "metricsCpuTempMode", "avg")))
